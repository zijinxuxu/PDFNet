...
class ManoModel(nn.Module):
    ...
    def __init__(self,
        ...
        full_regressor = self.process_J_regressor(j_regressor)
        self.register_buffer('full_regressor', full_regressor)
    ...
    def process_J_regressor(self, J_regressor):
        ...
        new_order = [0, 13, 14, 15, 16,
                     ...
                     10, 11, 12, 19,
                     7, 8, 9, 20]
        return J_regressor[new_order].contiguous()#.to(self.device)
    ...
    def forward(self, betas=None, global_orient=None, hand_pose=None, transl=None,
        ...
        ret_full_pose = torch.cat([full_pose,
                            betas,transl], dim=1)
        if return_verts:
        ...
        output = ModelOutput(vertices=vertices if return_verts else None,
                             ...
                             hand_pose = hand_pose,
                             full_pose=ret_full_pose if return_full_pose else None)
