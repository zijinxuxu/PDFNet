...
# from lib.models.networks.pointnet_plus import PointNet_Plus
BN_MOMENTUM = 0.1
...
class PoseResNet(nn.Module):
    ...
    def __init__(self, block, layers, heads, head_conv, opt=None):
        ...
        # input channel changes as RGBD
        input_channel = 4 if self.opt.depth else 3
        ...
        if 'params' in self.opt.heads:
            out_feature_size = self.opt.input_res // opt.down_ratio 
        ...
        # add PointNetPlus for depth encoding
        # self.pointnet = PointNet_Plus(opt)
    ...
    def forward(self, x, heatmaps = None, depth = None, ind = None): #[b,3,384,384]
